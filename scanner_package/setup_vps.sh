#!/bin/bash
# =============================================================================
# Tele Music Player — VPS Scanner Setup (AlmaLinux / RHEL / CentOS)
...
# Set your production WEBHOOK_SECRET here (or use an EnvironmentFile):
...
echo "   (and uncomment EnvironmentFile in the systemd unit)"
echo ""
echo "3. Enable the service:"
echo "     systemctl daemon-reload"
echo "     systemctl enable --now tele-music-scan"
echo ""
